...
class BanksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank" do
    assert_difference('Bank.count') do
      post banks_url, params: { bank: { checking: @bank.checking, name: @bank.name, routing: @bank.routing } }
    end
  ...
  test "should update bank" do
    patch bank_url(@bank), params: { bank: { checking: @bank.checking, name: @bank.name, routing: @bank.routing } }
